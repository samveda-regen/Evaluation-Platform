...
function buildInvitationBody(payload: InvitationEmailPayload): string {
  const lines = [
    ...
    '',
    'Your exam window will be from 2:00 PM to 6:00 PM. After this time, the portal will automatically close, so please ensure you complete your assessment within the given duration.',
    '',
...
function buildInvitationHtml(payload: InvitationEmailPayload): string {
  ...
  return [
    ...
    '<p>Your exam window will be from 2:00 PM to 6:00 PM. After this time, the portal will automatically close, so please ensure you complete your assessment within the given duration.</p>',
