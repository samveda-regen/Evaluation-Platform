  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F3F4F6', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      <div style={{
        ...
        {testInfo?.invitedBy && (
          <div style={{
            ...
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
              <path d="M4 4h16v12H4V4z" stroke="#F59E0B" strokeWidth="1.5" strokeLinejoin="round"/>
              <path d="M4 4l8 8 8-8" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        ...
        {testInfo && (
          <div style={{
            ...
            {/* Proctored */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', padding: '16px 10px', borderLeft: '1.5px solid #E5E7EB' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M12 3l7 3v5c0 4.5-3 8-7 9-4-1-7-4.5-7-9V6l7-3z" stroke="#F59E0B" strokeWidth="1.8" strokeLinejoin="round" strokeLinecap="round"/>
              </svg>
              <span style={{ fontSize: '13px', fontWeight: 700, color: '#111827' }}>
        ...
        <form onSubmit={handleContinue}>
          ...
          <p style={{ fontSize: '12px', color: '#F59E0B', margin: '0 0 20px' }}>Found in your invitation email.</p>
          ...
          <label style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', cursor: 'pointer', marginBottom: '22px' }}>
            <div
              ...
              style={{
                ...
                border: consented ? '2px solid #F59E0B' : '2px solid #D1D5DB',
                backgroundColor: consented ? '#F59E0B' : 'white',
            ...
            <span style={{ fontSize: '13px', color: '#374151', lineHeight: '1.6' }}>
              ...
              <span style={{ color: '#F59E0B', fontWeight: 500, cursor: 'pointer' }}>privacy terms</span>.
            </span>
          </label>
          ...
          <button
            ...
            style={{
              ...
              backgroundColor: loading || !accessCode.trim() || !consented ? '#FDE68A' : '#F59E0B',
      ...
      <p style={{ fontSize: '13px', color: '#9CA3AF', marginTop: '24px', textAlign: 'center' }}>
        ...
        <span style={{ color: '#F59E0B', fontWeight: 500 }}>support@talentstaq.io</span>
      </p>
    </div>
  );
}
